...
<template>
  <LandingContainer>
    <LandingSectionhead>
      ...
      <template v-slot:desc>bauzertifikate.de</template>
    </LandingSectionhead>

    <div class="mx-auto max-w-screen-lg mt-12">
      <div class="flex justify-center">
        <div class="max-w-7xl px-32 text-sm text-gray-800">
          <p>
            David Joos,
            Hannes Jungert
            <br />
            ...
            88212 Ravensburg
            <br />
            <a href="mailto:david@bauzertifikate.de">
          ...
          <p>
            ...
            Abs. 1 TMG f&#252;r eigene Inhalte auf diesen Seiten
            ...
            hiervon unber&#252;hrt. Eine diesbez&#252;gliche Haftung
          ...
          <p>
            ...
            Dritter, auf deren Inhalte kein Einfluss genommen werden
            kann. Deshalb kann f&#252;r diese fremden Inhalte auch
            ...
            Rechtsverletzungen werden derartige Links umgehend von
            dieser Website auf die rechtsverletzende Site entfernen.
          </p>
          <p>
          ...
          <p>
            ...
            Urheberrechtes bed&#252;rfen der vorherigen
